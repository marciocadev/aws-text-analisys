...
import { DynamoAttributeValue, DynamoPutItem,
DynamoUpdateItem } from "aws-cdk-lib/aws-stepfunctions-tasks";
    ...
    return new DynamoUpdateItem(this, 'DynamoDBUpdateLanguage', {
      ...
      expressionAttributeValues: {
        ...
        ":lang": DynamoAttributeValue.fromMap(
            {
              LanguageCode: DynamoAttributeValue.fromString(JsonPath.stringAt('$.LanguageCode')),
              Score: DynamoAttributeValue.fromString(JsonPath.numberAt('$.Score').toPrecision(2))
            }
          )
